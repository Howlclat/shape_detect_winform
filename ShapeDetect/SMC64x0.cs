...
namespace csSMC6X
{
    ...
    class SMC6X
    {
        ...
        *************************************************************/
        ...
        /*************************************************************
        说明：按字节读取铁电
        输入：连接句柄：handle；写入数据：pData，地址：addr
        输出：读取数据
        返回值：错误码
        *************************************************************/
        ...
        *************************************************************/
        ...
        /*************************************************************
        说明：四轴同时锁存或是各轴单独锁存
        输入：连接句柄：handle；enable 0：单独锁存， 1：同时锁存； 默认为同时锁存
        输出：无
        返回值：错误码
        *************************************************************/
        ...
        /*************************************************************
        说明：设置编码器LTC有效电平
        输入：连接句柄：handle；enable 0：低电平， 1：高电平； 默认为低电平
        输出：无
        返回值：错误码
        *************************************************************/
        ...
        *************************************************************/
        ...
        /*************************************************************
        说明：选择全部锁存时的外触发信号通道；可以由二个信号通道输入，
                     即LTC0, LTC1; 默认为LTC0
        输入：连接句柄：handle；num 信号通道选择号 0: LTC0锁存四个轴，         1: LTC1锁存四个轴
        输出：无
        返回值：错误码
        *************************************************************/
        ...
        /*************************************************************
        说明：选择编码器Speaker和LED的输出逻辑, 默认为低有效
        输入：连接句柄：handle；logic 0: 低有效，       1: 高有效
        输出：无
        返回值：错误码
        *************************************************************/
        ...
        *************************************************************/
        ...
        输入：axis 
               ...
               ez_mode: 暂开放0，1
				           0：EZ信号无效
                           1: 功能1：EZ是计数器复位信号 
                           2: 功能2：EZ是原点信号，且不复位计数器 
                           3: 功能3：EZ是原点信号，且复位计数器
        输出：无
        返回值：错误码
        *************************************************************/
